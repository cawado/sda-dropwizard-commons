...
public class OpenApiBundleTestApp extends Application<Configuration> {
   ...
   public void initialize(Bootstrap<Configuration> bootstrap) {
      //bootstrap.addBundle(OpenApiBundle.builder().withTitle(getName()).addResourcePackageClass(getClass()).build());
   ...
   @ApiResponse(responseCode = "200", description = "get", content = @Content(mediaType = APPLICATION_JSON, schema = @Schema(implementation = PartnerResource.class)))
   ...
   @ApiResponse(responseCode = "201", description = "post", headers = {
         @Header(name = "Location", description = "Location") })
   ...
   @ApiResponse(responseCode = "200", description = "get", content = @Content(mediaType = APPLICATION_JSON, schema = @Schema(implementation = HouseResource.class)))
