...
public final class OpenApiBundle implements ConfiguredBundle<Configuration> {
  ...
  /* private OpenApiBundle(Info info, String resourcePackages) {
      this.info = info;
   ...
   public OpenApiBundle(String resourcePackages) {
      this.resourcePackages = resourcePackages;
   }
   ...
   public void run(Configuration configuration, Environment environment) {
      ...
      SwaggerConfiguration oasConfig = new SwaggerConfiguration()
          .openAPI(oas)
          .prettyPrint(true)
          .resourcePackages(Stream.of("org.sdase.commons.server.openapi").collect(Collectors.toSet()));
...
//
//         return new OpenApiBundle(info, join(",", resourcePackages));
//      }
//
