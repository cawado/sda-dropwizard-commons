...
public class OpaRule extends ExternalResource {
  ...
  public static AllowBuilder onRequest(String method, String path) {
    return onRequest().withMethod(method).withPath(path);
  }
   ...
   *
   * <p>Please prefer to use {@code verify(count, onRequest().withMethod(method).withPath(path))}
   * instead.
   *
  ...
  public void verify(int count, String httpMethod, String path) {
    verify(count, onRequest().withMethod(httpMethod).withPath(path));
  }
  ...
  public static class StubBuilder
    ...
    public RequestPathBuilder withMethod(String method) {
